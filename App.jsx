...
export default function App() {
  ...
  // Balance & Commission State
  const [userBalance, setUserBalance] = useState(12450.00);
  const [totalCommissionEarned, setTotalCommissionEarned] = useState(350.00);

  // Profile Customization & Security State
  ...
  // 50+ Market Assets with Initial Live Price Simulation Support
  const [marketData, setMarketData] = useState([
    { name: "Bitcoin", symbol: "BTC", price: 64230.00, change: "+2.5%", isUp: true, logoBg: "bg-amber-500", logoText: "₿", sparklineColor: "#10b981", points: "10,25 25,18 40,30 55,15 70,20 85,8 100,12" },
    { name: "Ethereum", symbol: "ETH", price: 3450.00, change: "-1.2%", isUp: false, logoBg: "bg-indigo-600", logoText: "Ξ", sparklineColor: "#f43f5e", points: "10,10 25,20 40,15 55,28 70,22 85,32 100,35" },
    { name: "Tether", symbol: "USDT", price: 1.00, change: "+0.01%", isUp: true, logoBg: "bg-emerald-500", logoText: "₮", sparklineColor: "#06b6d4", points: "10,20 25,22 40,19 55,21 70,20 85,22 100,20" },
    { name: "Binance Coin", symbol: "BNB", price: 580.50, change: "+3.8%", isUp: true, logoBg: "bg-yellow-500 text-slate-950", logoText: "B", sparklineColor: "#eab308", points: "10,30 25,25 40,20 55,18 70,12 85,15 100,5" },
    { name: "Solana", symbol: "SOL", price: 145.20, change: "+5.4%", isUp: true, logoBg: "bg-gradient-to-tr from-purple-500 to-teal-400", logoText: "S", sparklineColor: "#10b981", points: "10,35 25,28 40,22 55,15 70,10 85,12 100,4" },
    ...
    { name: "Avalanche", symbol: "AVAX", price: 27.80, change: "+2.2%", isUp: true, logoBg: "bg-rose-600", logoText: "A", sparklineColor: "#f43f5e", points: "10,25 25,20 40,22 55,18 70,15 85,12 100,10" },
    { name: "Chainlink", symbol: "LINK", price: 13.40, change: "-1.5%", isUp: false, logoBg: "bg-blue-500", logoText: "⬡", sparklineColor: "#3b82f6", points: "10,12 25,18 40,20 55,25 70,22 85,28 100,30" },
    ...
    { name: "Litecoin", symbol: "LTC", price: 65.40, change: "+0.3%", isUp: true, logoBg: "bg-slate-500", logoText: "Ł", sparklineColor: "#64748b", points: "10,20 25,21 40,19 55,20 70,18 85,21 100,19" },
    { name: "Uniswap", symbol: "UNI", price: 6.80, change: "-0.9%", isUp: false, logoBg: "bg-pink-500", logoText: "🦄", sparklineColor: "#ec4899", points: "10,18 25,20 40,22 55,25 70,24 85,26 100,28" },
    ...
    { name: "Monero", symbol: "XMR", price: 162.10, change: "+0.5%", isUp: true, logoBg: "bg-orange-600", logoText: "ɱ", sparklineColor: "#f97316", points: "10,22 25,20 40,21 55,19 70,20 85,18 100,17" },
    { name: "NEAR Protocol", symbol: "NEAR", price: 4.50, change: "+6.1%", isUp: true, logoBg: "bg-black text-white", logoText: "N", sparklineColor: "#10b981", points: "10,32 25,25 40,20 55,15 70,12 85,8 100,5" },
    { name: "Stellar", symbol: "XLM", price: 0.095, change: "-0.2%", isUp: false, logoBg: "bg-slate-800", logoText: "∗</symbol>", sparklineColor: "#94a3b8", points: "10,18 25,19 40,20 55,21 70,20 85,22 100,21" },
    { name: "Aptos", symbol: "APT", price: 6.30, change: "+3.4%", isUp: true, logoBg: "bg-slate-900", logoText: "AP", sparklineColor: "#3b82f6", points: "10,28 25,22 40,19 55,15 70,18 85,12 100,10" },
    ...
    { name: "Render", symbol: "RENDER", price: 5.20, change: "+7.3%", isUp: true, logoBg: "bg-red-600", logoText: "R", sparklineColor: "#ef4444", points: "10,30 25,25 40,20 55,14 70,10 85,8 100,4" },
    { name: "Injective", symbol: "INJ", price: 18.90, change: "+4.1%", isUp: true, logoBg: "bg-purple-700", logoText: "INJ", sparklineColor: "#a855f7", points: "10,28 25,22 40,18 55,15 70,12 85,10 100,9" },
    ...
    { name: "Maker", symbol: "MKR", price: 2150.00, change: "+1.2%", isUp: true, logoBg: "bg-emerald-700", logoText: "M", sparklineColor: "#059669", points: "10,25 25,22 40,20 55,18 70,15 85,18 100,14" },
    { name: "Thorchain", symbol: "RUNE", price: 4.10, change: "-3.2%", isUp: false, logoBg: "bg-emerald-500", logoText: "R", sparklineColor: "#10b981", points: "10,12 25,18 40,22 55,28 70,30 85,35 100,38" },
    { name: "Aave", symbol: "AAVE", price: 135.00, change: "+3.5%", isUp: true, logoBg: "bg-purple-900", logoText: "👻", sparklineColor: "#a855f7", points: "10,28 25,24 40,20 55,17 70,15 85,12 100,10" },
    ...
    { name: "MultiversX", symbol: "EGLD", price: 26.50, change: "+0.3%", isUp: true, logoBg: "bg-slate-800", logoText: "E", sparklineColor: "#94a3b8", points: "10,20 25,21 40,20 55,19 70,20 85,18 100,19" },
    ...
    { name: "Zcash", symbol: "ZEC", price: 34.20, change: "+0.6%", isUp: true, logoBg: "bg-amber-500", logoText: "ⓩ", sparklineColor: "#f59e0b", points: "10,22 25,20 40,21 55,19 70,18 85,19 100,17" },
    { name: "Dash", symbol: "DASH", price: 24.80, change: "-0.3%", isUp: false, logoBg: "bg-blue-800", logoText: "Đ", sparklineColor: "#1e40af", points: "10,18 25,20 40,21 55,20 70,22 85,21 100,22" },
    { name: "Neo", symbol: "NEO", price: 10.50, change: "+2.2%", isUp: true, logoBg: "bg-emerald-600", logoText: "NEO", sparklineColor: "#059669", points: "10,25 25,22 40,19 55,17 70,15 85,13 100,11" },
    { name: "Kusama", symbol: "KSM", price: 18.40, change: "-1.0%", isUp: false, logoBg: "bg-slate-900", logoText: "KSM", sparklineColor: "#475569", points: "10,18 25,20 40,22 55,23 70,25 85,24 100,26" },
    ...
    { name: "Jito", symbol: "JTO", price: 2.80, change: "+9.5%", isUp: true, logoBg: "bg-purple-500", logoText: "JTO", sparklineColor: "#a855f7", points: "10,35 25,28 40,20 55,15 70,10 85,6 100,3" },
  ...
  // LIVE PRICE FLUCTUATION EFFECT (စျေးအတက်အကျ ကို အလိုအလျောက် တိုက်ရိုက်ပြောင်းပေးခြင်း)
  useEffect(() => {
    const liveInterval = setInterval(() => {
      setMarketData(prevData =>
        prevData.map(coin => {
          // ရာခိုင်နှုန်းအနည်းငယ် အတက်အကျလုပ်ရန်
    ...
    }, 2000); // ทุกๆ 2 วินาที สลับราคาขยับขึ้นลงแบบ Live

    return () => clearInterval(liveInterval);
  }, []);

  // Floating Chat Widget Drag & Drop
  const isDragging = useRef(false);
  const dragOffset = useRef({ x: 0, y: 0 });
  const [isChatOpen, setIsChatOpen] = useState(false);
  const [chatPos, setChatPos] = useState({ x: window.innerWidth - 80, y: window.innerHeight - 100 });
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      ...
      setLiveWithdrawals(prev => [newWithdrawal, ...prev.slice(0, 5)]);
    }, 4000);
  ...
  const handleSimulateNewReferralPurchase = (levelType, vipPlanObj) => {
...

    {
      activeTab === 'home' && (
        <div className="space-y-8">
          ...
          {/* MARKET TRENDS WITH 50+ COINS, LIVE PRICES & COLORFUL SPARKLINE CHARTS */}
              ...
              <table className="w-full text-left border-collapse">
                ...
                <tbody className={`divide-y ${darkMode ? 'divide-slate-800/60' : 'divide-slate-200'} text-sm`}>
                  {filteredMarkets.map((coin, index) => (
                    <tr key={index} className={`transition ${darkMode ? 'hover:bg-slate-800/40' : 'hover:bg-slate-50'}`}>
            ...
            {chatMessages.map((msg, index) => (
              <div key={index} className={`flex ${msg.sender === 'user' ? 'justify-end' : 'justify-start'}`}>
                <div className={`max-w-[75%] p-3.5 rounded-2xl text-xs leading-relaxed ${msg.sender === 'user'
                  ...
                  : `${darkMode ? 'bg-slate-800 border-slate-700 text-slate-200' : 'bg-white border-slate-300 text-slate-800'} border rounded-bl-none`
                  }`}>
                  {msg.text}
                </div>
              </div>
              ...
              <tbody className={`divide-y ${darkMode ? 'divide-slate-800/60' : 'divide-slate-200'}`}>
                {teamMembers.map((member) => (
                  <tr key={member.id} className={darkMode ? 'hover:bg-slate-800/40' : 'hover:bg-slate-50'}>
                    ...
                    <td className="p-4">
                      <span className={`px-3 py-1 rounded-full text-xs font-bold border ${member.level === 'Level 1' ? 'bg-emerald-500/10 text-emerald-400 border-emerald-500/30' :
                        member.level === 'Level 2' ? 'bg-blue-500/10 text-blue-400 border-blue-500/30' :
            ...
            <div className={`${darkMode ? 'bg-slate-950/80 border-slate-800' : 'bg-white border-slate-200'} border rounded-xl overflow-hidden`}>
              ...
              <div className={`divide-y ${darkMode ? 'divide-slate-800/60' : 'divide-slate-200'} text-xs font-medium`}>
                <div className="grid grid-cols-2 p-3">
                  <div>Level 1</div>
                  <div className="text-right text-emerald-400 font-bold">7%</div>
                </div>
                <div className="grid grid-cols-2 p-3">
                  <div>Level 2</div>
                  <div className="text-right text-cyan-400 font-bold">3%</div>
                </div>
                <div className="grid grid-cols-2 p-3">
                  <div>Level 3</div>
                  <div className="text-right text-purple-400 font-bold">1%</div>
                </div>
              </div>
            </div>
          </div>
    ...
    {/* ENHANCED PROFESSIONAL PROFILE DASHBOARD (ME TAB) */ }
    {
      activeTab === 'me' && (
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <div className={`bg-gradient-to-r ${darkMode ? 'from-purple-900/40 via-indigo-950 to-slate-900 border-slate-800' : 'from-purple-100 via-indigo-50 to-white border-slate-200'} border p-8 rounded-3xl shadow-2xl flex flex-col md:flex-row items-center justify-between gap-6`}>
            ...
            <div className="flex items-center gap-3 w-full md:w-auto justify-end">
              ...
              <button
                ...
                className="bg-rose-600/20 hover:bg-rose-600 text-rose-400 hover:text-white px-5 py-2.5 rounded-xl text-xs font-bold border border-rose-500/30 transition"
              >
                Log Out
              </button>
            </div>
                ...
                <div className="space-y-3 text-xs">
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full mt-1 ${darkMode ? 'bg-slate-900 border-slate-800 text-white' : 'bg-slate-100 border-slate-300 text-slate-900'} border rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-purple-500`}
                    />
                  </div>
                    ...
                    <div className="space-y-2">
                      <div>
                        ...
                        <input
                          ...
                          className={`w-full mt-1 ${darkMode ? 'bg-slate-900 border-slate-800 text-white' : 'bg-slate-100 border-slate-300 text-slate-900'} border rounded-xl px-4 py-2 text-sm focus:outline-none focus:border-purple-500`}
                        />
                      </div>
                      <div>
  ...
  {/* DRAGGABLE FLOATING SUPPORT CHAT WIDGET */ }
    < div
    ...
    <div className={`${darkMode ? 'bg-[#12161f] border-slate-800 text-white' : 'bg-white border-slate-200 text-slate-900'} border w-80 sm:w-96 rounded-3xl shadow-2xl overflow-hidden flex flex-col`}>
        ...
        {chatMessages.map((msg, index) => (
          <div key={index} className={`flex ${msg.sender === 'user' ? 'justify-end' : 'justify-start'}`}>
            <div className={`max-w-[80%] p-3 rounded-2xl text-xs leading-relaxed ${msg.sender === 'user'
              ...
              : `${darkMode ? 'bg-slate-800 text-slate-200' : 'bg-white text-slate-800 border border-slate-200'} rounded-bl-none shadow-sm`
              }`}>
              {msg.text}
            </div>
          </div>
      ...
      <form onSubmit={handleSendMessage} className={`p-3 border-t ${darkMode ? 'border-slate-800 bg-[#12161f]' : 'border-slate-200 bg-white'} flex gap-2`}>
        <input
          ...
          className={`flex-1 ${darkMode ? 'bg-slate-900 border-slate-800 text-white' : 'bg-slate-100 border-slate-300 text-slate-900'} border rounded-xl px-3 py-2 text-xs focus:outline-none focus:border-purple-500`}
        />
  ...
  < footer className = {`border-t ${darkMode ? 'border-slate-800 text-slate-300' : 'border-slate-200 text-slate-600'} mt-20 py-8`}>
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="text-center md:text-left">
            ...
            <a href="LINE Account" target="_blank" rel="noopener noreferrer" className="text-xs text-emerald-400 hover:underline">LINE Account</a>
          </div>

          <div className="flex items-center gap-3 md:gap-4">
            {/* LINE */}
            <a href="LINE Account" target="_blank" rel="noopener noreferrer" aria-label="LINE" className="w-10 h-10 sm:w-11 sm:h-11 flex items-center justify-center rounded-full transition transform hover:scale-105 focus:outline-none" title="LINE">
            ...
            {/* Facebook */}
            <a href="#" aria-label="Facebook" className="w-10 h-10 sm:w-11 sm:h-11 flex items-center justify-center rounded-full transition transform hover:scale-105 focus:outline-none" title="Facebook">
            ...
            {/* Messenger */}
            <a href="#" aria-label="Messenger" className="w-10 h-10 sm:w-11 sm:h-11 flex items-center justify-center rounded-full transition transform hover:scale-105 focus:outline-none" title="Messenger">
            ...
            {/* Instagram */}
            <a href="#" aria-label="Instagram" className="w-10 h-10 sm:w-11 sm:h-11 flex items-center justify-center rounded-full transition transform hover:scale-105 focus:outline-none" title="Instagram">
            ...
            {/* Telegram */}
            <a href="#" aria-label="Telegram" className="w-10 h-10 sm:w-11 sm:h-11 flex items-center justify-center rounded-full transition transform hover:scale-105 focus:outline-none" title="Telegram">
            ...
            {/* LinkedIn */}
            <a href="#" aria-label="LinkedIn" className="w-10 h-10 sm:w-11 sm:h-11 flex items-center justify-center rounded-full transition transform hover:scale-105 focus:outline-none" title="LinkedIn">
            ...
            {/* WhatsApp */}
            <a href="#" aria-label="WhatsApp" className="w-10 h-10 sm:w-11 sm:h-11 flex items-center justify-center rounded-full transition transform hover:scale-105 focus:outline-none" title="WhatsApp">
